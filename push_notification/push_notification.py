...
sqs_client = boto3.client(
    'sqs',
    aws_access_key_id='AKIASOLZQNS77AT7HCNT',
    aws_secret_access_key='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',
    ...
    try:
        if not user_id or not fcm_token:
            ...
            response = sqs_client.send_message(
                QueueUrl='https://sqs.ap-south-1.amazonaws.com/168295427263/FCM-notification',
