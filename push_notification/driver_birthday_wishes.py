...
class BirthdayWishes:
    def get_drivers_detail(self):
        ...
        api_url = 'https://windblade.moeving.com/fleet/notification/push'
        bearer_token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJha2FzaC5rdW1hckBtb2V2aW5nLmNvbSIsImV4cCI6MTcwNzIxNDQ0OH0.-rvqmK_6UoL1B6mWBo9SwQVvX_7qztHtwnHf6hAOpM0'
