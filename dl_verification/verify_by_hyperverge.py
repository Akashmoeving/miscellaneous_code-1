...
aws_s3_config = {
    ...
    'aws_secret_access_key': 'abcdefgh+Rx/jdXP',
    'folder_name': "profile",
...
api_url = 'https://ind-verify.hyperverge.co/api/checkDL'
...
def save_to_database(data, user_id, image_path, dl_number, transaction_id):
    conn = mysql.connector.connect(host="db-service.moeving.app", user="live_user", password="c30W;1R4GY:1PC^&uO$5",
                                   database="moevingdb")
    cursor = conn.cursor()
