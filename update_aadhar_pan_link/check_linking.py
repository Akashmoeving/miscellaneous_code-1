...
bearer_token = ('eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9'
                '.eyJzdWIiOiJha2FzaC5rdW1hckBtb2V2aW5nLmNvbSIsImV4cCI6MjAzOTUwNzA1NX0'
                '.OiZ89wYZiO5vCu1fA1d52KqpBhxLX95uqEotiJkay-4')
...
encrypt_pan_aadhar = "https://windblade.moeving.com/fleet/common/encrypt"
decrypt_pan = "https://windblade.moeving.com/fleet/common/decrypt"
check_pan_aadhar_linking = 'https://ind.thomas.hyperverge.co/v1/fetchPANDetailed'
pan_detailed_header = {
    'appId': 'o4b584',
    'appKey': '6ml2af95csbbkyl1xskz',
    'Content-Type': 'application/json'
}
...
# Prod
url = 'https://chat.googleapis.com/v1/spaces/AAAAc5Yb5K4/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=cDQjg_fqvYjQCmTGrdHHgQeeAgNFfzQUkX92zbkvTm0'

# Test
# url = 'https://chat.googleapis.com/v1/spaces/AAAAQqFHSzs/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=ObHS4RWRvTHdYPm7JR_o6pkfayQD_SGcAHzDcbj0Rtk%3D'
http_obj = Http()
