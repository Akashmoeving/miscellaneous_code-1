...
check_pan = ("select pd.pan, pd.linked_aadhar_number, is_aadhar_linked from pan_detail pd  where "
             " pan in ('n5Z2QiQ058CXFQsQ0CRXGA==','87vRmLj+GR7IFTAIUdfHJw==','DDeRe9/b2Vd+VUpAmMeT6A==',"
             "'enwU7omGm6zDnYL3W0oPoA==','iZFgYcpQd6ey05+LlKUobw==');")

cursor.execute(check_pan)
data_from_pan = cursor.fetchall()
print(data_from_pan)

bearer_token = ('eyJhbGciOiJIUzI1NiJ')
