    ...
    if not pan_details:
        try:
            ...
            if (aadhar_pan_link_response['status'] == 'success' and
                ...
                insertInto_pan_details = """INSERT INTO moevingdb.pan_detail( pan, linked_aadhar_number, dob, name, email, phone,
                ...
                insert_unverified_pan = """INSERT INTO moevingdb.pan_detail(pan, created_by,user_id, remarks) 
                                            VALUES(%s, %s, %s, %s);"""
...
# Prod
url = 'https://chat.googleapis.com/v1/spaces/AAAAc5Yb5K4/messages?key=AIzaSyDdI0hCZtE6vySjMm-&token=cDQjg_fqvYjQCmTGrdHHgQeeAgNFfzQUkX92zbkvTm0'

# Test
# url = 'https://chat.googleapis.com/v1/spaces/AAAAQqFHSzs/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=%3D'
http_obj = Http()
