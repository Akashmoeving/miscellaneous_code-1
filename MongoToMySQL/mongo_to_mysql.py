...
def post_to_webhook(bot_msg):
    ...
    #        '&token=ObHS4RWRvTHdYPm7JR_o6pkfayQD_SGcAHzDcbj0Rtk%3D')

    # Prod
    url = ('https://chat.googleapis.com/v1/spaces/AAAAKqbLC0g/messages?key=-WEfRq3CPzqKqqsHI'
           '&token=RFAWBu3kmrLlG8UTakYW2P_53ATOyOAuNibEtNU6I7M')
    http_obj = Http()
...
def call_data_insert():
    ...
    insert_query = "INSERT INTO moevingdb.vehicle_soc_data (vehicle_id, soc, updated_on) VALUES (%s, %s, %s)"
