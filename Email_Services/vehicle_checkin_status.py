...
class vehicle_details:
    def fetch_vehicle_data(self):
        ...
        sender_email = 'connect@moeving.com'
        receiver_emails = ['akash.kumar@moeving.com', 'program@moeving.com']
        ...
        smtp_port = 587
        smtp_username = 'system.insights@moeving.com'
        smtp_password = 'ddwi djyf kwfh bxfg'
